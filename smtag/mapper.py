index2label = {0: 'small_molecule', 1: 'gene', 2: 'protein', 3: 'subcellular', 4: 'cell', 5: 'tissue', 6: 'organism', 7: 'undefined',
               ...
               19: 'panel_start', 20: 'panel_stop'}
               
label2index = {index2label[k]:k for k in index2label}

brat_map = {'': None, 'DISO': 18, 'PRGE': 1, 'GENE': 1, 'LIVB': 6, 'CHED':0}

xml_map = {
            'marks':{
                    'sd-tag':{
                            'type':{'':None, 'molecule':0, 'gene':1, 'protein':2, 'subcellular':3, 'cell':4, 'tissue':5, 'organism':6, 'undefined':7},
