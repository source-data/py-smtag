...
class TokenizerTest(unittest.TestCase):
    def setUp(self):
        self.examples = [
            ...
            ("Atg5-/- IM-123 VSV‐eGFP IFN‐β B-cell Atg7-β+/+ cases", ['Atg5','-/-', 'IM-123', 'VSV', '‐', 'eGFP', 'IFN‐β', 'B-cell', 'Atg7-β', '+/+', 'cases']),
            ("Atg5",["Atg5"]),
            ("this is β-actin talking to INF-γ in af-123 T-cells", ['this', 'is', 'β-actin', 'talking', 'to', 'INF-γ', 'in', 'af-123', 'T-cells']),
